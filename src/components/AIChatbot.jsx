    ...
    <>
      ...
      <motion.button
        ...
        animate={{ 
          scale: 1,
          boxShadow: [
            "0px 0px 0px 0px rgba(249, 115, 22, 0.8)", 
            "0px 0px 0px 20px rgba(249, 115, 22, 0)",
            "0px 0px 0px 0px rgba(249, 115, 22, 0)"
          ]
        }}
        transition={{ 
        ...
        className={`position-fixed bottom-0 end-0 m-4 z-3 rounded-circle border-0 d-flex align-items-center justify-content-center ${isOpen ? 'd-none' : 'd-flex'}`}
